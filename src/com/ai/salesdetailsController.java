        ...
        try
        {
        	...
        	if (result.size()>0)
        	{
	        	...
	        	for(int i=0; i<result.size();i++)
	        	{
	        		...
	        		Font fontheader = FontFamily.forName("BBClarity").getFont(FontFamily.SCALABLE_FONT, 13);	        		
	        		...
	        		Font fontdetails = FontFamily.forName("BBClarity").getFont(FontFamily.SCALABLE_FONT, 12);	        		
